/**
 * TRABALHO PRATICO - DISCIPLINA TEORIA DOS GRAFOS
 * PROGRAMA PARA RESOLVER O PROBLEMA DE ENCONTRAR CLIQUE MÁXIMA EM UM GRAFO
 * PROFESSOR: MARCO ANTONIO M. CARVALHO
 * ALUNOS: MANOEL STILPEN E JOÃO PAULO REIS ALVARENGA
 * 2017
 */
